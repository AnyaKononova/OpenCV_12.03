...
int main() {
    Mat src = imread("C:/Users/Nuta/Documents/Open CV/Практика 2/zad12.jpg");
    if (src.empty()) {
        cout << "Error" << endl;
        return -1;
    }
    ...
    for (size_t i = 0; i < circles.size(); i++) {
        ...
        circle(color_dst, center, radius, Scalar(255, 0, 0), 3, LINE_AA); // Рисуем круги поверх изображения с линиями
    }

    namedWindow("Lines and Circles", WINDOW_AUTOSIZE);
    imshow("Lines and Circles", color_dst);

    imwrite("result.jpg", color_dst);
